        ...
        "/api/exam_attempts/{attempt_id}/log_activity": {"post": {
            ...
            "requestBody": {"required": True, "content": {"application/json": {"schema": {
                ...
                "properties": {
                    "event_type": {
                        "type": "string",
                        "enum": ["tab_switch","devtools_attempt","no_face_detected","multiple_faces","copy_paste","fullscreen_exit","window_blur","tab_closed","gaze_away","head_turned","talking_detected","face_covered","suspect_object_detected","suspect_object_confirmed","sustained_audio_detected","multi_screen_detected","env_scan_completed","env_scan_person_detected","env_scan_unavailable","face_detection_unavailable","live_monitoring_unavailable"],
